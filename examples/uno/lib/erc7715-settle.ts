 ...
 * pattern, adapted for Nexus UNO's entry-fee charge.
 *
 ...
 *
 * This REPLACES, for the ERC-7715 player, the custom budget-delegation charge in
 * lib/engine.ts (chargeEntryFee). The funds come from the grant's `from` (the
